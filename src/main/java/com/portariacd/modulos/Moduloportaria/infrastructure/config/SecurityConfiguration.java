        ...
        return security.cors(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(e->
                        e.requestMatchers(HttpMethod.POST,"/portaria/v1/usuario/login").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET,"/module/v1/filial/lista").permitAll()
                                .requestMatchers(HttpMethod.GET,"/entregaChaves/lista").permitAll()
                                .requestMatchers(HttpMethod.POST,"/consumer/biometria/user").permitAll()
                                .requestMatchers(HttpMethod.POST,"/entregaChaves/devolucao/token").permitAll()
                                .requestMatchers(HttpMethod.GET,"/armario/unico").permitAll()
                                .requestMatchers(HttpMethod.GET,"/entregaChaves/top3/{filial}/arm/{id}").permitAll()
